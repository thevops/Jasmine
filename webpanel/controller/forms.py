...
class HostsAddForm(forms.ModelForm):
    """ Add host. 
    TODO:
    - dns_name strip polskich znaków"""
...
class GroupsAddForm(forms.ModelForm):
    """ Add group. """
    name = forms.CharField(required=True, max_length=64, label="nazwa grupy")
    description = forms.CharField(widget=forms.Textarea, required=True, label="opis")
